...
def main():
    ...
    config = yaml.safe_load(open('Config/config_pretrain.yaml', 'r'))
    ...
    wandb_logger = WandbLogger(
        project="MM", save_dir=logger_path, name='Pretrain')
    ...
    print('dataset size:', len(dm.train_dataloader().dataset))
